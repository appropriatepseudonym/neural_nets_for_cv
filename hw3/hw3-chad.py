...
# from sklearn.metrics import train_test_splitf
# from keras.models  import classification_report
# from keras.layers.core import Sequential
# from keras.optimizers import Densefrom
...
model.compile(loss="categorical_crossentropy", optimizer=sgd,
    metrics=["accuracy"])
H = model.fit(trainX, trainY, validation_split=0.25, epochs=100,
    batch_size=128)
...
print(classification_report(testY.argmax(axis=1), predictions.argmax(axis=1),
    target_names=[str(x) for x in lb.classes]))
